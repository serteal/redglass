...
ALL_DATASETS: list[type[DialogueDataset | TargetedDialogueDataset]] = [
    data.AdvBenchDataset,
    data.LmSysChatDataset,
    data.AlpacaDataset,
    data.CircuitBreakersDataset,
    data.JailbreakBenchDataset,
    data.MaliciousInstructDataset,
    data.StrongREJECTDataset,
    data.XSTestDataset,
]
...
ALL_DATASETS_DICT: dict[str, type[DialogueDataset | TargetedDialogueDataset]] = {
...
def get_class_from_name(
    class_name: str,
) -> type[DialogueDataset | TargetedDialogueDataset]:
...
class DatasetRepository:
    ...
    def _get_dataset_info(
        ...
        return {
            ...
            "Model": model,
            "Length": length,
            "Num Safe": label_counts[Label.SAFE],
            "Num Unsafe": label_counts[Label.UNSAFE],
            "Num Skip": label_counts[Label.SKIP],
        }
