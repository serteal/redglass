...
from redglass.utils import squeeze_sparse_tensor


class Detector(ABC):
    """
    Abstract base class for activation-based detectors.
    """
    ...
    @classmethod
    @abstractmethod
    def load(cls, file_path: str | Path) -> "Detector":
        """
...
class DirectionDetector(Detector):
    ...
    def save(self, file_path: str | Path):
        ...
        data = {
            "layers": self.layers,
            "directions": self.directions.cpu()
    ...
    def fit(self, positive_acts: Activations, negative_acts: Activations) -> None:
        ...
        Args:
            positive_inputs (Inputs): Inputs corresponding to unsafe statements.
            negative_inputs (Inputs): Inputs corresponding to safe statements.
        """
        ...
...
class LogisticRegressionDetector(DirectionDetector):
    ...
    def save(self, file_path: str | Path):
        ...
        data = {
            ...
            "scaler_scale": self.scaler_scale.cpu()
